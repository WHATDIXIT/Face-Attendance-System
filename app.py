...
if not st.session_state.logged_in:
    ...
    st.write("<p style='text-align: center; color: gray;'>Please authenticate with security credentials to gain master access to the network.</p>", unsafe_allow_html=True)
    
    # Center the login form visually to ensure it forces browser elements to wake up
